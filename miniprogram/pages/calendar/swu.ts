...
Page({ 
  ...
  data: {
    eventsArray:[],
    semesterTitle: ['2020-2021-2','2021-2022-1','2021-2022-2','2022-2023-1', '2022-2023-2','2023-2024-1','2023-2024-2','2024-2025-1'],
    index: 4,//学期选择的索引
    ...
    semesters:[['2016-2017-1','2016-9-4',19,6]
      ...
      ,['2023-2024-1','2023-9-1',19,6]
      ,['2023-2024-2','2024-2-19',19,6]
      ,['2024-2025-1','2024-9-1',19,6]
  ],
},
  addEvents:function(){
	  //月历中填充事件
